...
export default function Hero() {
  return (
      <div className=" hero-content md:grid md:grid-cols-2 md:mt-56 mt-15 h-screen flex flex-col-reverse ">
        <div className=' font-bold text-5xl md:text-left text-center grid grid-col-2 md:place-items-start place-items-centermd:ml-20 md:h-32 mt-10' style={{color:'#40a9e9'}}>
