...
export default function Hero() {
  return (
      <div className=" hero-content grid md:grid-cols-2 md:mt-56 mt-20 ">
        <div className=' font-bold text-5xl text-left grid grid-col-2 place-items-start ml-20 h-32 mt-10' style={{color:'#40a9e9'}}>
